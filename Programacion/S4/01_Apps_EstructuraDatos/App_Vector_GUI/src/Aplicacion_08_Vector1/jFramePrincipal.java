...
public class jFramePrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabProm = new javax.swing.JTextField();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jLabProm, javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jLabProm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
int del = 0;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        vec = new VectorT(modelo.getRowCount());        
        for (int i = 0; i < modelo.getRowCount(); i++) {
            vec.asignar((double)Integer.parseInt(modelo.getValueAt(i, 0)+""), i);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for(int i = 0; i< modelo.getRowCount(); i ++){
            modelo.setValueAt(rand.nextInt(99)+1.0, i, 0);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) {
            vec.asignar((double)(modelo.getValueAt(i, 0)), i);
        }
        
        jLabMay.setText(VectorT.mayor(vec)+"");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        jLabMen.setText(VectorT.menor(vec)+"");
    ...
    private javax.swing.JTextField jLabProm;
