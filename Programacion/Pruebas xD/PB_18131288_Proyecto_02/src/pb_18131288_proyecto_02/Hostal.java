 ...
 */
 class Hostal {
    ...
    public Hostal(int moyo, int cantara, int azumbre){
        miMoyo = moyo;
        miCantara = cantara;
        miAzumbre = azumbre;
...
public Hostal suma (Hostal copia){
   ...
   return new Hostal(divMoyos, cantaritas, azumbritas);
   
} 

public Hostal resta (Hostal copia){
   int azumbresFinal = azumbresTotales() -  copia.azumbresTotales();
 ...
 public Hostal promedio(Hostal v, int n)
    {
...
public double precioAzumbres(Hostal copia, double precio){
    int Azumbres;
