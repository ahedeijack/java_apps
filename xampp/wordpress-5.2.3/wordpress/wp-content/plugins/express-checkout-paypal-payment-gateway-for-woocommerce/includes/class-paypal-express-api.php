...
class Eh_PayPal_Express_Payment extends WC_Payment_Gateway {
            ...
            case 'finish_express':
                ...
                try {
                    ...
                    if ($response['ACK'] == 'Success' || $response['ACK'] == 'SuccessWithWarning') {
                        $user_creation = $this->create_account($checkout_post);
    ...
    public function create_account($checkout_post) {
        ...
        if (isset($checkout_post['createaccount']) && $checkout_post['createaccount']) {
            ...
            if (!empty($checkout_post['billing_email']) && !empty($checkout_post['account_password'])) {
                ...
                $data = array(
                    ...
                    'user_pass' => $checkout_post['account_password'],
                );
                ...
                if (!is_wp_error($userID)) {
                    ...
                    $user_password = esc_attr($checkout_post['account_password']);
    ...
    public function shipping_parse($response) {
        ...
        if (isset($response['ADDRESSSTATUS']) && isset($response['FIRSTNAME'])) {
            $shipping_details = array
                (
                'first_name' => ($this->paypal_allow_override ? $post_data['billing_first_name'] : $response['FIRSTNAME']),
                'last_name' => ($this->paypal_allow_override ? $post_data['billing_last_name'] : (isset($response['LASTNAME']) ? $response['LASTNAME'] : '')),
