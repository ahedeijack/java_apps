 ...
 * @author jose_
 */
public class appColaCircular_Menu {
    ...
    public static void colaSimple(String tipo)
    {
        switch(tipo)
        {
            case "Integer":
            {
                ...
                ColaCircularT<Integer> cola = new ColaCircularT<Integer>(5);
            ...
            case "Double":
            {
                ...
                ColaCircularT<Double> cola = new ColaCircularT<Double>(5);
                Scanner teclado = new Scanner(System.in);
                boolean band = true;
                while(band = true)
                {
            ...
            case "String":
            {
                ...
                ColaCircularT<String> cola = new ColaCircularT<String>(5);
                Scanner teclado = new Scanner(System.in);
                boolean band = true;
                while(band = true)
                {
                    ...
                    switch(op)
                    {
                        ...
                        {    
                            ...
                            {                  //obtenemos nombres aleatorios
                                cola.insertar(nombres.get(random.nextInt(nombres.size())));   //azul
                                System.out.println("\033[34m OK, DATO INSERTADO");
                                cola.mostrar();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("EJEMPLOS UTILIZANDO COLA CIRCULAR");
        int opc;
        boolean band = true;
        while(band)
        {
